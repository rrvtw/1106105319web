...
<section id="one" style="display:flex;">
    ...
    @method('PUT')
        ...
        <div class="row">
            <div class="col">
                <input type="text" class="form-control" name="link_name" value="{{ $link->link_name }}" required>
                <hr>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                <input type="text" class="form-control" name="sort" value="{{ $link->sort }}" required>
                <hr>
            </div>
        </div>

        <div class="row">
            <input type="submit" class="btn primary" value="連結修改" />
        </div>
